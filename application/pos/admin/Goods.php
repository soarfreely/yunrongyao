    ...
    public function index()
    {
        ...
        if($this->request->isAjax()){
            ...
            if($categoryid){
                ...
                $child_categoryid = CategoryModel::get($categoryid)->ChildrenCategory($categoryid);
            }
            $data_list = GoodsModel::whereIn('categoryid',$child_categoryid)->where($map)->select();
            if($data_list){
            ...
            $category = CategoryModel::where('companyid',session('user_auth.companyid'))
            ->order('sort,categoryid')->column('categoryid,parentid,category,sort');
            ...
            return $this->fetch('category/goodslist');
        }
    }
